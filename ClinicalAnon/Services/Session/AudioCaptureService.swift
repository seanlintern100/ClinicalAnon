...
class AudioCaptureService: NSObject, ObservableObject {
    ...
    // Real-time mic gating removed — gating is now done post-capture at transcription time
    ...
    private func handleMicrophoneBuffer(_ buffer: AVAudioPCMBuffer) {
        ...
        // Note: Real-time mic gating removed — gating is now done post-capture at
        // transcription time using both audio files on disk (perfect timing alignment).
        // AEC still runs here to reduce echo energy in the saved file.
